  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col justify-center items-center px-4 sm:px-6 lg:px-8">
      <div className="text-center">
        ...
        <div className="mt-10">
          <Link to='/' className="inline-block px-4 py-2 text-sm font-medium text-light-black bg-bright-blue rounded-md border border-sky-500 hover:bg-amber hover:border-solid hover:border hover:border-sky-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-colors duration-300">Go back</Link>
        </div>
      </div>
    </div>
  )
